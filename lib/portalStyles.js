...
export const PORTAL_CSS = `
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .asgn-share-btn{display:inline-flex;align-items:center;gap:8px;font-size:14.5px;font-weight:700;color:var(--muted);background:rgba(255,255,255,.04);border:1px solid var(--border);border-radius:24px;cursor:pointer;padding:9px 18px;margin-left:auto;transition:color .2s,border-color .2s,background .2s;}
