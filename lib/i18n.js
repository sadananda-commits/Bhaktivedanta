...
export const UI_STRINGS = {
  ...
  nav_features:  { en: 'Features',  da: 'Funktioner' },
  ...
  nav_enroll_now: { en: 'Join — It\'s Free', da: 'Tilmeld — Gratis' },
  ...
  // ── Landing page · about ──
  about_lbl: { en: 'About The Platform', da: 'Om Platformen' },
  about_h_1: { en: 'Why our community', da: 'Hvorfor vores fællesskab' },
  about_h_2: { en: 'built this platform', da: 'byggede denne platform' },
  about_sub: { en: 'A free alternative to the apps we all rely on — built and maintained by our own community, for our own community.', da: 'Et gratis alternativ til de apps, vi alle er afhængige af — bygget og vedligeholdt af vores eget fællesskab, for vores eget fællesskab.' },

  features_lbl: { en: 'What You Can Do', da: 'Hvad Du Kan Gøre' },
  features_h:   { en: 'Everything in one free place', da: 'Alt samlet ét gratis sted' },
  features_sub: { en: 'No juggling separate apps for meetings, quizzes, practice questions, and homework — it all lives in the same portal.', da: 'Ingen grund til at bruge separate apps til møder, quizzer, øvelsesspørgsmål og lektier — det hele findes i samme portal.' },
  feat_qbank_title: { en: 'Question Bank', da: 'Spørgsmålsbank' },
  feat_qbank_desc:  { en: 'Browse by Class → Subject → Chapter and practice at your own pace, with instant feedback on every answer.', da: 'Gennemse efter klassetrin → fag → kapitel, og øv dig i dit eget tempo med øjeblikkelig feedback på hvert svar.' },
  feat_meetings_title: { en: 'Meetings', da: 'Møder' },
  feat_meetings_desc:  { en: 'Create and join online meetings like Zoom — no time limits, no mandatory host, and no subscription needed.', da: 'Opret og deltag i onlinemøder ligesom Zoom — ingen tidsbegrænsning, ingen krav om vært, og intet abonnement nødvendigt.' },
  feat_quizzes_title: { en: 'Live Quizzes', da: 'Live Quizzer' },
  feat_quizzes_desc:  { en: 'Parents and teachers run interactive quizzes like Kahoot — set the timing and make revision fun.', da: 'Forældre og lærere kører interaktive quizzer ligesom Kahoot — sæt tidsbegrænsningen og gør repetition sjov.' },
  feat_assignments_title: { en: 'Assignments & Tracking', da: 'Opgaver & Opfølgning' },
  feat_assignments_desc:  { en: 'Assign tasks, track each student\'s progress, and get suggestions on where to focus next.', da: 'Tildel opgaver, følg hver elevs fremskridt, og få forslag til, hvor der bør fokuseres næste gang.' },

  // ── Landing page · classes ──
  classes_lbl: { en: 'Question Bank', da: 'Spørgsmålsbank' },
  classes_h:   { en: 'Pick a class level', da: 'Vælg et klassetrin' },
  classes_sub: { en: 'Six class levels, each with its own set of subjects and chapters in the Question Bank — pick yours to get started.', da: 'Seks klassetrin, hver med eget sæt af fag og kapitler i spørgsmålsbanken — vælg dit for at komme i gang.' },
  classes_age: { en: 'Age', da: 'Alder' },

  // ── Landing page · subjects ──
  subjects_lbl: { en: 'What\'s Covered', da: 'Hvad Der Er Dækket' },
  subjects_h_1: { en: 'Five core subjects,', da: 'Fem kernefag,' },
  subjects_h_2: { en: 'ready to practice', da: 'klar til at øve' },
  subjects_sub: { en: 'Each subject has its own chapters in the Question Bank, plus live quizzes teachers and parents can host.', da: 'Hvert fag har sine egne kapitler i spørgsmålsbanken, samt live quizzer som lærere og forældre kan afholde.' },
  subjects_topics_covered: { en: 'Topics Covered', da: 'Emner Dækket' },
  subjects_learning_goal:  { en: 'Learning Goal', da: 'Læringsmål' },
  subjects_teaching_method:{ en: 'How You Practice', da: 'Sådan Øver Du' },
  ...
  test_lbl: { en: 'Community Stories', da: 'Fællesskabshistorier' },
  test_h:   { en: 'What our community says', da: 'Hvad vores fællesskab siger' },
  test_sub: { en: 'Real words from parents, students, and teachers using the platform.', da: 'Rigtige ord fra forældre, elever og lærere, der bruger platformen.' },

  // ── Landing page · FAQ ──
  faq_lbl: { en: 'Got Questions?', da: 'Har Du Spørgsmål?' },
  faq_h:   { en: 'Frequently Asked Questions', da: 'Ofte Stillede Spørgsmål' },
  faq_sub: { en: 'Everything people ask before joining — answered clearly and honestly.', da: 'Alt folk spørger om før tilmelding — besvaret klart og ærligt.' },
  ...
  enroll_h:   { en: 'Create Your Free Account', da: 'Opret Din Gratis Konto' },
  enroll_sub: { en: 'Select your role below — student, parent, or teacher. Your account is created instantly and free, on submission.', da: 'Vælg din rolle nedenfor — elev, forælder eller lærer. Din konto oprettes øjeblikkeligt og gratis ved indsendelse.' },
  enroll_step_student: { en: 'Student', da: 'Elev' },
  enroll_step_parent:  { en: 'Parent', da: 'Forælder' },
  enroll_step_course:  { en: 'Subjects', da: 'Fag' },
  enroll_step_confirm: { en: 'Confirm', da: 'Bekræft' },
  // ── Role selector (Step 0) ───────────────────────────────────────────────
  enroll_role_heading:   { en: "Who's joining?", da: 'Hvem tilmelder sig?' },
  enroll_role_sub:       { en: 'Choose your role to see the right sign-up form.', da: 'Vælg din rolle for at se den rigtige tilmeldingsformular.' },
  enroll_role_student:   { en: 'Student', da: 'Elev' },
  enroll_role_student_d: { en: 'Create a profile to use the Question Bank', da: 'Opret en profil for at bruge spørgsmålsbanken' },
  ...
  enroll_role_teacher_d: { en: 'Host quizzes and assign chapters', da: 'Afhold quizzer og tildel kapitler' },
  ...
  f_pt_note_teacher:   { en: "We'll configure your student access shortly. Contact the community organizers if you need it sooner.", da: 'Vi konfigurerer din adgang til elever hurtigst muligt. Kontakt fællesskabets organisatorer, hvis du har brug for det hurtigere.' },
  f_pt_disclaimer:     { en: 'By submitting you confirm all details are accurate.', da: 'Ved at indsende bekræfter du, at alle oplysninger er korrekte.' },
  ...
  f_next_course: { en: 'Next: Subjects', da: 'Næste: Fag' },
  ...
  f_subjects_required: { en: 'Subjects You\'re Interested In', da: 'Fag Du Er Interesseret I' },
  ...
  f_cred_warning: { en: '⚠ Please keep these credentials safe. The same details have been emailed to your registered email address..', da: '⚠ Tag et skærmbillede eller skriv disse oplysninger ned. Du bliver bedt om at vælge et nyt kodeord ved første login.' },
  ...
  // ── Landing page · footer ──
  footer_brand_desc: { en: 'A free, community-built learning & collaboration platform — Question Bank, hostless meetings, live quizzes, and progress tracking, from KG onwards.', da: 'En gratis, fællesskabsbygget lærings- og samarbejdsplatform — spørgsmålsbank, møder uden vært, live quizzer og fremskridtsopfølgning, fra børnehaveklasse og opefter.' },
  footer_academy: { en: 'Platform', da: 'Platform' },
  ...
  footer_rights: { en: '© 2026 Vedanta Academy. A free, community-built platform.', da: '© 2026 Vedanta Academy. En gratis, fællesskabsbygget platform.' },
  page_title: { en: 'Vedanta Academy | Community Learning & Collaboration Platform', da: 'Vedanta Academy | Fællesskabets Lærings- og Samarbejdsplatform' },
  page_meta_description: { en: 'A free, community-built learning & collaboration platform — Question Bank, hostless meetings, live quizzes, and progress tracking.', da: 'En gratis, fællesskabsbygget lærings- og samarbejdsplatform — spørgsmålsbank, møder uden vært, live quizzer og fremskridtsopfølgning.' },
