...
export const UI_STRINGS = {
  ...
  classes_sub: { en: 'Ten class levels, each with a tailored curriculum, learning objectives, and teaching approach designed for that specific age group.', da: 'Seks klassetrin, hver med et skræddersyet pensum, læringsmål og undervisningsmetode designet til netop den aldersgruppe.' },
  ...
  // ── Landing page · footer ──
  footer_brand_desc: { en: 'Vedanta Academy — dedicated foundational coaching built to scale child proficiency while keeping primary learning fun, engaging, and outcome-focused. Schools aligned, KG onwards.', da: 'Vedanta Academy — dedikeret grundlæggende undervisning bygget til at styrke børns færdigheder, mens læring forbliver sjov, engagerende og resultatorienteret. School-tilpasset, fra børnehaveklasse til 10. klasse.' },
  ...
  footer_rights: { en: '© 2026 Vedanta Academy. All Rights Reserved. School Aligned · KG Ownwards.', da: '© 2026 Vedanta Academy. Alle Rettigheder Forbeholdes. School-tilpasset · Børnehaveklasse til 5. klasse.' },
  page_title: { en: 'Vedanta Academy | Learning Support Portal', da: 'Vedanta Academy | Ekspert Hjemmeundervisning Børnehaveklasse – 5. Klasse' },
  page_meta_description: { en: 'Vedanta Academy — Learn as you play – helping children learn through fun, interactive experiences, with your parents….', da: 'Vedanta Academy — Eksklusiv School-hjemmeundervisning. Mikrohold, fremskridtsdashboards i realtid, erfarne mentorer. Børnehaveklasse til 5. klasse.' },
